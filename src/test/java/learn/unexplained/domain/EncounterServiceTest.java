...
class EncounterServiceTest {
    ...
    @Test
    void shouldFailWithInvalidId() throws DataAccessException {
        Encounter encounter = new Encounter(0, EncounterType.CREATURE, "2/2/2019", "test description", 1);
        boolean actual = service.update(encounter).isSuccess();
        assertFalse(actual);
    }

    @Test
    void shouldUpdateSucceedWithValidId() throws DataAccessException {
    ...
    @Test
    void shouldFailWithDupilicateEverything() throws DataAccessException {
        Encounter encounter = new Encounter(1, EncounterType.VISION, "Thursday", "It was odd", 2);
        boolean actual = service.update(encounter).isSuccess();
        assertFalse(actual);
    }

    @Test
    void shouldSucceedWithChanges() throws DataAccessException {
        Encounter encounter = new Encounter(
                2, EncounterType.CREATURE, "Thursday", "It was odd", 2);
        boolean actual = service.update(encounter).isSuccess();
        assertTrue(actual);
    }

    @Test
    void shouldDeleteWithCorrectId() throws DataAccessException {
        boolean success = service.deleteById(2).isSuccess();
        assertTrue(success);
    }

    @Test
    void shouldFailToDeleteWithIncorrectId() throws DataAccessException {
        boolean success = service.deleteById(3).isSuccess();
        assertFalse(success);
    }
